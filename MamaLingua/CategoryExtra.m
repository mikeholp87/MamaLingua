...
@synthesize english_singular, english_plural, english_pho, spanish_fm, spanish_nofm, spanish_plural, spanish_pho, primaryLbl, secondaryLbl, phoneticLbl, pluralLbl, langType, selectedTab, category;
...
- (void)viewDidLoad
{
    ...
    [typeBtn setTitle:selectedTab forState:UIControlStateNormal];
